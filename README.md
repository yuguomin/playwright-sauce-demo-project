# Sauce Demo 自动化测试项目
一个使用 Playwright 和 TypeScript 构建的企业级 Web 自动化测试框架，对 [Sauce Demo](https://www.saucedemo.com/) 网站进行端到端测试。
...
### Allure 报告
![Allure Report Screenshot](./docs/images/report.png) <!-- 记得放一张你的报告截图 -->
